...
obtainInstruction("steak", 0)
  ...
  .catch((error) => {
    console.error("There was an error obtaining instructions: ", error);
  });
...
async function makeBroccoli() {
  ...
  try {
    ...
    console.error(
      "There was an error obtaining broccoli instructions: ",
      error
    );
  }
}
...
Promise.all(stepPromises)
  ...
  .catch((error) => {
    console.error("There was an error obtaining brussels sprouts instructions: ", error);
  });
